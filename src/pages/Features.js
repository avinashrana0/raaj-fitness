...
useEffect(() => {
  ...
  return (
    <>
       <div className="faq--header" background-image= 'none' ><h1>Features</h1></div>
       <div className="fet--contain">
          <div className='title'>
                ...
                <p>We specialize in providing the equipment and coaching for <span>Strongman</span>, <span>Weightlifting</span>, and<span> Arm Sports</span>.</p>
                </div>
